import { toggleWishlist, getWishlist } from "./wishlist.js";
...
const bookTemplate = (book) => `<Card>
    <button class="favorite-btn" onclick="favorite(${book.id})">${
  wishlist.includes(book.id) ? icon1 : icon
}</button>
     <div class="book-cover">
     <img src="${book?.formats["image/jpeg"]}" alt="book cover"/></div>
